...
<div class="row">
    ...
    <div class="row">
        <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
            ...
            <thead>
            <tr>
                <th>@sortablelink('produts_name', __('views.admin.products.index.table_header_0'),['page' => $products->currentPage()])</th>
                <th>@sortablelink('produts_code',  __('views.admin.products.index.table_header_1'),['page' => $products->currentPage()])</th>
