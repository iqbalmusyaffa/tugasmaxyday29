            ...
            @foreach($purchaseOrderLines as $purchaseOrderLine)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('admin.purchase.order.lines.destroy', [$purchaseOrderLine->id]) }}" class="btn btn-xs btn-danger user_destroy" data-toggle="tooltip" data-placement="top" data-title="{{ __('views.admin.purchase.order.lines.index.delete') }}" onclick="return confirm('Are you sure you want to delete this item?')">
